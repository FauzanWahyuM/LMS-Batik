        ...
        <article class="rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-200 px-6 py-5">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-slate-900">Peserta Individu</h1>
                        <p class="mt-1 text-sm text-slate-600">Daftar lengkap semua peserta individu yang terdaftar</p>
                    </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="2" class="px-6 py-12 text-center text-slate-500">
                                        ...
                                        <p class="mt-4 font-semibold">Tidak ada peserta individu</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="border-t border-slate-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <p class="text-xs text-slate-600">Menampilkan {{ count($individualParticipants ?? []) }} dari
                        {{ count($individualParticipants ?? []) }} peserta</p>
