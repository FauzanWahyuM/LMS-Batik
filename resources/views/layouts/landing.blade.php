    ...
    <nav class="bg-gradient-to-r from-blue-800 to-blue-950 shadow-lg fixed w-full top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex md:items-center md:space-x-1">
                    ...
                    <a href="/login"
                        class="bg-amber-600 text-white px-6 py-2 rounded-lg text-sm font-medium hover:bg-amber-700 transition ml-4">
                        Login
                    </a>
                </div>
                ...
                <div class="md:hidden flex items-center">
                    <button id="mobile-menu-button" class="text-white hover:text-amber-300 focus:outline-none">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-blue-900 border-t border-blue-700">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="/login"
                    class="block px-3 py-2 bg-amber-600 text-white rounded-md text-center font-medium">Login</a>
            </div>
        </div>
    </nav>
    ...
    <footer class="bg-blue-950 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div class="border-t border-blue-900 mt-12 pt-8 text-center">
                <p class="text-gray-400 text-sm">&copy; 2026 LPK Kama Praja Madiun. All rights reserved.</p>
            </div>
        </div>
    </footer>
